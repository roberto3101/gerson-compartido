...
-- Stubs de otras capacidades + 18 tablas + indices + 85 procedimientos (44 nuevos: mantenimiento, incidencias, intervenciones, ajustes de recuperacion, parametros, y variantes de catalogo actualizar/baja/reactivar).
