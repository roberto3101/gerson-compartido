...
-- Stubs de otras capacidades + 20 tablas + indices + 95 procedimientos (incluye depreciacion mensual por uso y por contrato, responsables de asignacion, activos sin asignar, datos economicos, y muro de fechas de depreciacion en registro/edicion).
